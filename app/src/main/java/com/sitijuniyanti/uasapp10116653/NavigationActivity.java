...
import com.sitijuniyanti.uasapp10116653.View.KontakFragment;
import com.sitijuniyanti.uasapp10116653.View.ProfilFragment;
...
public class NavigationActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_daftar_teman) {
            Fragment fragment = new ListTemanFragment();
            callFragment(fragment);
